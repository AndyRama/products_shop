...
Product.create!(sku: 'XU4 64', name:'XU4 N64', price_cents:'5000', category: nano, photo_url: 'XU4N64.PNG')
Product.create!(sku: 'Console X', name:'X N64', price_cents:'4000', category: console, photo_url: '64PI4.PNG')
Product.create!(sku: 'N64 MINI', name:'N64',price_cents:'6000', category: nano, photo_url: 'XU4N64.PNG')
